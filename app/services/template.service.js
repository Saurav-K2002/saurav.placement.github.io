const from = '"Placement Portal" <placementportal@gift.edu.in>';
const baseUrl = 'http://placements.gift.edu.in';
const email_signature = '<br><br>With Regards.<br><br>Prof. Samir Panda<br>In-charge, Training & Placement<br>GIFT Bhubaneswar<br>+91-8292738623';
    ...
    switch (mailType) {
        ...
        case 'sendOTP':
            return {
                ...
                subject: 'Login Request : Placement Cell, GIFT Bhubaneswar',
                text: 'Hello '+ data.student_name + 'We have received a login request for your account.Please find the below OTP to proceed further With Regards, Prof.Samir Panda',
        ...
        case 'forgotPassword':
            return {
                from: from,
                to: data.college_email,
                subject: 'Reset Password Request : Placement Cell, GIFT Bhubaneswar',
                text: 'Hello '+ data.student_name + 'You requested for the reset password.Please find the below link Reset password With Regards, Prof. Samir Panda',
        ...
        case 'passwordUpdated':
            return {
                from: from,
                to: data.college_email,
                subject: 'Password Updated : Placement Cell, GIFT Bhubaneswar',
                text: 'Hello '+ data.student_name + 'Your password has been successfully updated.With Regards, Prof. Samir Panda',
        ...
        case 'approveInterviewExperience':
            return {
                ...
                text: 'Hello '+ data.author_name + 'Thanks for sharing your interview process and thoughts with us With Regards, Prof. Samir Panda',
